    ...
    <div className="about-section section" id="about">
      ...
      <div className="about-flex">
        <div className="about__text">
          ...
          <p className="margin__btm">Outside the world of coding I enjoy staying active by riding my bike and practicing yoga, travel, reading, cooking and good coffee.</p>
